...
if not load_name_generator(first_name_gen, 'first_name_gen.pth'):
    train_name_generator(first_name_gen, first_names, first_name_char_to_idx, first_name_max_len)
    save_name_generator(first_name_gen, 'first_name_gen.pth')
if not load_name_generator(last_name_gen, 'last_name_gen.pth'):
    train_name_generator(last_name_gen, last_names, last_name_char_to_idx, last_name_max_len)
    save_name_generator(last_name_gen, 'last_name_gen.pth')
if not load_name_generator(nickname_gen, 'nickname_gen.pth'):
    train_name_generator(nickname_gen, nicknames, nickname_char_to_idx, nickname_max_len)
    save_name_generator(nickname_gen, 'nickname_gen.pth')
